...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_node_fetch__ = __webpack_require__(4);
...
class Censys {
  ...
  run({ method = 'GET', action, id, options, callback = () => {} }) {
    ...
    if (id) address += `/${id}`;
    return Object(__WEBPACK_IMPORTED_MODULE_0_node_fetch__["a" /* default */])(address, {
      method,
